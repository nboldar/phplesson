...
<header class="main-header">
    <div class="main-header-conteiner">
        <a href="/" class="main-header-logo"><img src="../img/icon/logo.png" alt="logo" class="main-header-logo"></a>
        <div class="search">
            ...
            <div id="slider">
                <div id="slider-wrapper">
                    <div class="showed">
                        ...
                        <p class="caption ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci
                            consequuntur
                    ...
                    <div class="slide">
                        ...
                        <p class="caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet commodi culpa
                            cupiditate eum eveniet exercitationem iste molestiae nostrum omnis quaerat. Cum dolorum
                            error
                    ...
                    <div class="slide">
                        ...
                        <p class="caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquam
                            aspernatur assumenda dicta distinctio error ex harum hic ipsum natus odio perspiciatis
                            quasi,
                            quibusdam reprehenderit soluta suscipit unde voluptatibus? Maxime?</p>
                    </div>
                    <div class="slide">
                        <img src="../img/slider/slider_img3.png" alt=""/>
                        <p class="caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor est facilis
                            ipsam
                            officiis porro possimus quas. A at delectus doloremque ea explicabo necessitatibus nisi quis
                            quo
                    ...
                    <div class="slide">
                        ...
                        <p class="caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, dolore et eum
                            magnam natus optio rem. Accusantium dicta exercitationem modi neque odio pariatur possimus,
                            quas
    ...
    <div class="foot-footer">
        <div class="foot-footer-conteiner">
            ...
            <ul class="foot-footer-share">
                ...
                <li><a class="social-share" href="javascript://"><span class="fa fa-pinterest-p"
                                                                       aria-hidden="true"></span></a>
                </li>
                <li><a class="social-share" href="javascript://"><span class="fa fa-google-plus"
                                                                       aria-hidden="true"></span></a>
                </li>
            </ul>
        </div>
