...
<body>
    ...
    <header class="main-header">
        <div class="main-header-conteiner">
            <a href="index.php" class="main-header-logo"><img src="img/icon/logo.png" alt="logo" class="main-header-logo"></a>
            <div class="search">
    ...
    <div class="big_foto"><img src="<?=$img_url?>" alt="Choose Your Style"></div>
    <!-- тот большой квадрат с продажей и выбором -->
    <section class="choose-the-item">
        <span class="head-of-single"><?=$gender?> collection <div class="inside-head"></div></span>
        <span class="head-of-collection"><?=$brend?> cheap and chic</span>
       ...
       rather than exceptional portals.</span>
        ...
        <span class="price-of-collection">$<?=$price?></span>
    ...
    <div class="may-like-also">
        ...
        <div class="product-search-product-card">
            <?= renderProductCards("gender='$gender'");?>
        </div>
    </div>
    <!--                                                  - -->
    <!-- начинается футер -->
